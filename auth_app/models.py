...
class Student(models.Model):
    # Asosiy login (formadan kiritilgan, API ga yuborilgan)
    username = models.CharField(
        max_length=150, unique=True,
        help_text="Tizimga kirish uchun foydalaniladigan login (Talaba ID raqami)"
    )
    # API dan kelgan tasdiqlangan ma'lumotlar
    ...
    last_name = models.CharField(max_length=100, blank=True, null=True) # API dagi 'second_name'
    patronymic = models.CharField(max_length=100, blank=True, null=True) # API dagi 'third_name'
    full_name_api = models.CharField(max_length=255, blank=True, null=True, help_text="API dan kelgan to'liq F.I.Sh.")
    short_name_api = models.CharField(max_length=100, blank=True, null=True, help_text="API dan kelgan qisqa F.I.Sh.")

    image_url = models.URLField(max_length=500, blank=True, null=True)
    birth_date_timestamp = models.BigIntegerField(null=True, blank=True, help_text="API dan kelgan tug'ilgan sana (timestamp)")
    passport_pin = models.CharField(max_length=50, blank=True, null=True)
    passport_number = models.CharField(max_length=50, blank=True, null=True)
    email = models.EmailField(blank=True, null=True)
    phone = models.CharField(max_length=30, blank=True, null=True)

    gender_code = models.CharField(max_length=10, blank=True, null=True)
    gender_name = models.CharField(max_length=50, blank=True, null=True)

    university_name_api = models.CharField(max_length=255, blank=True, null=True, help_text="API dan kelgan Universitet nomi")

    # Specialty (Mutaxassislik)
    specialty_id_api = models.CharField(max_length=100, blank=True, null=True)
    specialty_code_api = models.CharField(max_length=50, blank=True, null=True)
    specialty_name_api = models.CharField(max_length=255, blank=True, null=True)

    # Student Status
    student_status_code = models.CharField(max_length=10, blank=True, null=True)
    student_status_name = models.CharField(max_length=100, blank=True, null=True)

    # Education Form (Ta'lim shakli)
    education_form_code = models.CharField(max_length=10, blank=True, null=True)
    education_form_name = models.CharField(max_length=100, blank=True, null=True)

    # Education Type (Ta'lim turi)
    education_type_code = models.CharField(max_length=10, blank=True, null=True)
    education_type_name = models.CharField(max_length=100, blank=True, null=True)

    # Payment Form (To'lov shakli)
    payment_form_code = models.CharField(max_length=10, blank=True, null=True)
    payment_form_name = models.CharField(max_length=100, blank=True, null=True)

    # Group
    group_id_api = models.IntegerField(null=True, blank=True)
    group_name_api = models.CharField(max_length=100, blank=True, null=True)
    group_education_lang_code = models.CharField(max_length=10, blank=True, null=True)
    group_education_lang_name = models.CharField(max_length=50, blank=True, null=True)

    # Faculty
    faculty_id_api = models.IntegerField(null=True, blank=True)
    faculty_name_api = models.CharField(max_length=255, blank=True, null=True)
    faculty_code_api = models.CharField(max_length=50, blank=True, null=True)

    # Education Language (Asosiy ta'lim tili, guruhnikidan farqli bo'lishi mumkin)
    education_lang_code = models.CharField(max_length=10, blank=True, null=True)
    education_lang_name = models.CharField(max_length=50, blank=True, null=True)

    # Level (Kurs)
    level_code = models.CharField(max_length=10, blank=True, null=True) # API dagi 'level.code'
    level_name = models.CharField(max_length=50, blank=True, null=True) # API dagi 'level.name' (kurs nomi)

    # Semester
    semester_id_api = models.IntegerField(null=True, blank=True)
    semester_code_api = models.CharField(max_length=10, blank=True, null=True)
    semester_name_api = models.CharField(max_length=100, blank=True, null=True)
    semester_is_current = models.BooleanField(null=True, blank=True)
    semester_education_year_code = models.CharField(max_length=20, blank=True, null=True)
    semester_education_year_name = models.CharField(max_length=100, blank=True, null=True)
    semester_education_year_is_current = models.BooleanField(null=True, blank=True)

    avg_gpa = models.CharField(max_length=10, blank=True, null=True) # String sifatida, chunki '3.50'
    password_is_valid_api = models.BooleanField(null=True, blank=True)

    address_api = models.TextField(blank=True, null=True)

    # Country
    country_code_api = models.CharField(max_length=10, blank=True, null=True)
    country_name_api = models.CharField(max_length=100, blank=True, null=True)

    # Province (Viloyat)
    province_code_api = models.CharField(max_length=20, blank=True, null=True)
    province_name_api = models.CharField(max_length=100, blank=True, null=True)

    # District (Tuman)
    district_code_api = models.CharField(max_length=20, blank=True, null=True)
    district_name_api = models.CharField(max_length=100, blank=True, null=True)

    # Social Category
    social_category_code = models.CharField(max_length=10, blank=True, null=True)
    social_category_name = models.CharField(max_length=100, blank=True, null=True)

    # Accommodation (Turar joyi)
    accommodation_code = models.CharField(max_length=10, blank=True, null=True)
    accommodation_name = models.CharField(max_length=100, blank=True, null=True)

    validate_url_api = models.URLField(max_length=500, blank=True, null=True)

    # Tizim uchun ma'lumotlar
    last_login_api = models.DateTimeField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

    # raw_api_data = models.JSONField(null=True, blank=True, help_text="API dan kelgan barcha ma'lumotlar") # Agar kerak bo'lsa
